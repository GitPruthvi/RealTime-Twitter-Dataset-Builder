...
This repository can be used to create multiple twitter datasets by streaming real-time tweets, based on #hashtags, into a database that can be used for further classification and analysis.

## My Scenario
Below is my scenario on how I created my own dataset from real-time tweets and how I used it to analyze things.
